...
Write-Information 'Setting up environment variables'
[Environment]::SetEnvironmentVariable('NPM_CONFIG_USERCONFIG', "$env:USERPROFILE/.config/npm/npmrc", [EnvironmentVariableTarget]::User)
